...
const SoinChirurgieVisceral: React.FC = () => {
    const [soinsData, setSoinsData] = useState<Soin[]>([]);
    const [selectedImage, setSelectedImage] = useState<string | null>(null);

    useEffect(() => {
        fetch('http://127.0.0.1:8000/soins-chirurgie-visceral')
    ...
    return (
        <div>
            ...
            <div className="container-fluid pt-5 mt-5" style={{ paddingTop: '130px' }}>
                ...
                >
                    <h1 className="display-1 text-capitalize text-white mb-4">SERVICE CHIRURGIE VISCERAL</h1>
                </div>
                ...
                <div className="container-fluid service">
                    <div className="container py-5">
                        <div className="section-title mb-5">
                            ...
                            <p className="mb-4" style={{ fontSize: '25px' }}>Vous trouvez ci-dessous nos soins pour le service chirurgie visceral.</p>
                        </div>
                            ...
                            {soinsData.map((soin) => (
                                <div className="col-md-6 col-lg-4" key={soin.SoinsId}>
                                    <div className="service-item rounded">
                                        ...
                                        <div className="service-content rounded-bottom bg-light p-4" style={{ display: 'flex', flexDirection: 'column', height: '360px' }}>
...
export default SoinChirurgieVisceral;