...
const SoinCRTS: React.FC = () => {
  const [soinsData, setSoinsData] = useState<Soin[]>([]);
  const [selectedImage, setSelectedImage] = useState<string | null>(null);

  useEffect(() => {
    fetch('http://127.0.0.1:8000/soins-crts')
    ...
    <div>
      ...
      <div className="container-fluid pt-5 mt-5" style={{ paddingTop: '130px' }}>
        <div
          ...
          style={{
            backgroundImage: "url('/img/batiment-crts.jpg')",
        ...
        >
          <h1 className="display-1 text-capitalize text-white mb-4">SERVICE CENTRE REGIONALE DE LA TRANSFUSION SANGUINE</h1>
        </div>
        ...
        <div className="container-fluid service">
          <div className="container py-5">
            <div className="section-title mb-5">
              ...
              <p className="mb-4" style={{ fontSize: '25px' }}>Vous trouvez ci-dessous nos soins pour le service CRTS.</p>
            </div>
              ...
              {soinsData.map((soin) => (
                <div className="col-md-6 col-lg-4" key={soin.SoinsId}>
                  <div className="service-item rounded">
                    ...
                    <div className="service-content rounded-bottom bg-light p-4" style={{ display: 'flex', flexDirection: 'column', minHeight: '180px' }}>
        ...
        <div className="container-fluid feature">
          <div className="container py-5">
            <div className="section-title mb-5">
              <div className="sub-style">
                <h1 className="sub-title px-3 mb-0">Condition de don de sang</h1>
              </div>
            </div>
            <div className="row justify-content-center">
              {soinsData.map((soin) =>
                soin.conditions.map((condition, index) => (
                  <div className="col-md-12 col-lg-12 col-xl-12" key={`${soin.SoinsId}-${index}`}>
                    <div className="feature-item p-4">
                      <div className="feature-content d-flex flex-column" style={{ height: '270px', fontSize: '25px' }}>
                        <h3>{soin.SoinsTitre} :</h3>
                        <p className='mb-4 text-black-500'><i className="fas fa-quote-left"></i>{condition.ConditionList}<i className="fas fa-quote-right"></i></p>
                      </div>
                    </div>
                  </div>
                ))
