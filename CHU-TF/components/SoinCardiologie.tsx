...
const SoinCardiologie: React.FC = () => {
  const [soinsData, setSoinsData] = useState<Soin[]>([]);
  const [selectedImage, setSelectedImage] = useState<string | null>(null);

  useEffect(() => {
    fetch('http://127.0.0.1:8000/soins-cardiologie')
  ...
  return (
    <div>
      ...
      <div className="container-fluid pt-5 mt-5" style={{ paddingTop: '130px' }}>
        ...
        >
          <h1 className="display-1 text-capitalize text-white mb-4">SERVICE CARDIOLOGIE</h1>
        </div>
        ...
        <div className="container-fluid service">
          <div className="container py-5">
            <div className="section-title mb-5">
              ...
              <p className="mb-4" style={{ fontSize: '25px' }}>Vous trouvez ci-dessous nos soins pour le service Cardiologie.</p>
            </div>
...
export default SoinCardiologie;