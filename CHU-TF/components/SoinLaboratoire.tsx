...
const SoinLaboratoire: React.FC = () => {
  const [soinsData, setSoinsData] = useState<Soin[]>([]);
  const [selectedImage, setSelectedImage] = useState<string | null>(null);

  useEffect(() => {
    fetch('http://127.0.0.1:8000/soins-laboratoire/')
    ...
    <div>
      ...
      <div className="container-fluid pt-5 mt-5" style={{ paddingTop: '130px' }}>
        <div
          ...
          style={{
            backgroundImage: "url('/img/batiment-laboratoire.jpg')",
        ...
        >
          <h1 className="display-1 text-capitalize text-white mb-4">SERVICE LABORATOIRE</h1>
        </div>
        ...
        <div className="container-fluid service">
          <div className="container py-5">
            <div className="section-title mb-5">
              ...
              <p className="mb-4" style={{ fontSize: '25px' }}>Vous trouvez ci-dessous nos soins pour le service Laboratoire.</p>
            </div>
              ...
              {soinsData.map((soin) => (
                <div className="col-md-6 col-lg-4" key={soin.SoinsId}>
                  <div className="service-item rounded">
                    ...
                    <div className="service-content rounded-bottom bg-light p-4" style={{ display: 'flex', flexDirection: 'column', minHeight: '360px' }}>
        ...
        <div className="container-fluid feature">
          <div className="container py-5">
            <div className="section-title mb-5">
              <div className="sub-style">
                <h1 className="sub-title px-3 mb-0">Condition de prélèvement</h1>
              </div>
              <p className="mb-4" style={{ fontSize: '25px' }}>L'horaire pour le prélèvement est de 7h à 9h pour le service Laboratoire.
                Un prélèvement immédiat pour un urgence.
              </p>
            </div>
            <div className="row justify-content-center">
              {soinsData.map((soin) =>
                soin.conditions.map((condition, index) => (
                  <div className="col-md-8 col-lg-8 col-xl-6" key={`${soin.SoinsId}-${index}`}>
                    <div className="feature-item p-4">
                      <div className="feature-content d-flex flex-column" style={{ height: '230px', fontSize: '25px' }}>
                        <h2 className="mb-4">{soin.SoinsTitre}</h2>
                        <p className='mb-4'>{condition.ConditionList}</p>
                      </div>
                    </div>
                  </div>
                ))
...
export default SoinLaboratoire;
